# Hackseries-Expense-Splitter-contracts
...
By default the template creates a single `HelloWorld` contract under contract_main folder in the `smart_contracts` directory. To add a new contract:
